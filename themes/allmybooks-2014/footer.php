    ...
    <footer id="site-footer">
			...
			<p>
				...
				echo '<a target="_blank" id="github-link" href="https://github.com/gvorbeck/all-my-books" title="github repo">' . file_get_contents( locate_template( "_images/icons/github.svg" ) ) . 'Running AMB v1.1 (Bradbury)</a>';
				?>
			</p>
    </footer>
    <?php wp_footer(); ?>
