    ...
    <footer id="site-footer">
      <div id="site-footer-content">
        ...
        <p id="site-credit">AMB created by <a href="http://iamgarrett.com" title="iamgarrett">Garrett Vorbeck</a>.</p>
        ...
        <a class="site-footer--admin-link" href="<?php echo admin_url(); ?>" title="AMB Admin" target="_blank"><?php echo svg_cms(); ?></a>
      </div>
    </footer>
