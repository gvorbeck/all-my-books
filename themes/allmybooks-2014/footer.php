      ...
      <footer id="site-footer" class="content">
        ...
        <p id="github-link"><?php echo '<a target="_blank" href="https://github.com/gvorbeck/all-my-books/releases/tag/v1.3" title="github repo"><span>all-my-books v1.4 (Ellis)</span>'. svg_github() .'</a>';
          ?>
        </p>
      </footer>
    </div> <!-- #container -->
